...
class ConsultaControllerTest {
    ...
    private MockMvc mvc;
    @Autowired
    JacksonTester<DadosAgendaConsulta> dadosAgendaConsultaJSON;
    @Autowired
    JacksonTester<DadosDetalahamentoConsulta> dadosDetalahamentoConsultaJSON;
    @MockBean
        ...
        var response = mvc
                .perform(
                        post("/consultas")
                                ...
                                .content(dadosAgendaConsultaJSON.write(
                                        new DadosAgendaConsulta(2l, 5l, data, especialidade)
                                ).getJson())
                )
                .andReturn().getResponse();
